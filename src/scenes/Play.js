class Play extends Phaser.Scene{
    ...
    create(){
        ...
        this.AtoDecrease = this.add.bitmapText(width/2, height/2, font, 'D to decrease speed', 50).setOrigin(0.5).setTint(0xFFFFFF).setScale(0)
        this.quotetoIncrease = this.add.bitmapText(width/2, height/2 + 50, font, 'K to increase speed', 50).setOrigin(0.5).setTint(0xFFFFFF).setScale(0)
